...
from muss.fairseq.main import fairseq_train_and_evaluate_with_parametrization, evaluate_with_parametrization
...
result = evaluate_with_parametrization(**kwargs)
